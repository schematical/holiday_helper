...
BaseFacebook.prototype.getRequestParam = function(key) {
  ...
  //if (this.request.query && this.request.query.hasOwnProperty(key)) {//NOTE: I Hacked this
  if (this.request.query && this.request.query[key]) {
    return this.request.query[key];
  }
  else if (this.request.body && this.request.body[key]) {
  //else if (this.request.body && this.request.body.hasOwnProperty(key)) {//NOTE: I Hacked this
